...
global.sig = "https://www.instagram.com/SadZetsun._";
global.syt = "https://m.youtube.com/c/RndyCok";
...
/*============== PAYMENT ==============*/
global.pdana = "6283897011555"; //dana
global.povo = "-"; //ovo
global.pgopay = "-"; //gopay
global.plinkaja = "-"; //link aja
global.ppulsa = "6283897011555"; //telkomsel
...
global.namebot_1 = "Nahida-Md";
global.nameown = "RanZyL";
...
global.lolkey = "sgwn"; // PUNYA WAHID  8e66d0934cf741bfd2182c16

/*============== STAFF ==============*/
global.owner = [
  ["6283897011555", "RanZyL", true],
  ["-", "-", true],
];
...
/*============== LOGS ==============*/
global.logs = {
  error: "6283897011555@s.whatsapp.net",
  anticulik: "6283897011555@s.whatsapp.net",
  stats: "6283897011555@s.whatsapp.net",
};
